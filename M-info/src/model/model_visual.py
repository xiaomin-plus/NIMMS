...
from .layer_visual import BertLayer, BertPooler
...
class UniterEncoder(nn.Module):
    ...
    def forward(self, input_, attention_mask, attn_vis_all, attn_txt_all,
        ...
        for layer_module in self.layer:
            hidden_states, attention_scores, visual_output = layer_module(hidden_states, attention_mask, attn_vis_all, attn_txt_all)
...
class UniterModel(UniterPreTrainedModel):
    ...
    def forward(self, input_ids, position_ids,
                img_feat, img_pos_feat,
                attention_mask, attn_vis_all, attn_txt_all, gather_index=None, img_masks=None,
                output_all_encoded_layers=True,
                txt_type_ids=None, img_type_ids=None):
        ...
        encoded_layers, all_attention_scores,visual_outputs = self.encoder(
            embedding_output, extended_attention_mask, attn_vis_all, attn_txt_all,
